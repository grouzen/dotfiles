...
(defun color-theme-my-charcoal-black ()
  ...
  (color-theme-install
   '(color-theme-charcoal-black
     ...
     (font-lock-constant-face ((t (:foreground "Gray80"))))
     (font-lock-doc-face ((t (:foreground "Gray80" :slant italic))))
     (font-lock-doc-string-face ((t (:foreground "sky blue"))))
     (font-lock-function-name-face ((t (:bold t :foreground "Gray80" :slant italic :weight bold))))
     (font-lock-keyword-face ((t (:bold t :foreground "Gray80" :weight bold))))
     (font-lock-reference-face ((t (:foreground "Gray80"))))
     (font-lock-string-face ((t (:foreground "Gray70" :weight bold :slant italic))))
     (font-lock-type-face ((t (:bold t :foreground "Gray80" :weight bold))))
     (font-lock-variable-name-face ((t (:bold t :foreground "Gray80" :slant italic :weight bold))))
     (font-lock-warning-face ((t (:bold t :foreground "Gray80" :weight bold))))
